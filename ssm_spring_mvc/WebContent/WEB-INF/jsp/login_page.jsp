...
<body class="login_page">
        ...
        <div class="login_register_form">
            <div class="form_wrapper animated-short" id="login_form">
                ...
                <form id="loginForm" action="${pageContext.request.contextPath }/login/doLogin.do" method="post">
                    ...
                    <div class="form-group sepH_c">
                        <a href="javascript:doucment:loginForm.submit()" class="btn btn-lg btn-primary btn-block">Log in</a>
                    </div>
                </form>
            </div>
